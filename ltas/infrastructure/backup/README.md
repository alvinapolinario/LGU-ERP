...
5. Phase 2 quarantine objects live in the development MinIO volume. Inventory/copy MinIO separately. A MySQL dump without that object inventory is not a complete recovery set once any upload intent exists.
