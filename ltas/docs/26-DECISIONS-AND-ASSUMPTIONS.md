...
| ADR-17 | Selected design | Phase 3 referrals engineering authorized 2026-09-22. Secretariat-recorded lead/joint referrals; CS sees only referred measures. Hearings, reports, CH/CM, and session-sourced referrals remain TBD | See [31](31-PHASE-3-REFERRALS.md). Closing a referral is not a committee finding. Source kind `SECRETARIAT_RECORDED` is not IRP |
| ADR-18 | Selected design | Phase 3 meetings and documents engineering authorized 2026-09-22. Secretariat-recorded schedule/edit/close; agenda binds existing same-committee referrals; COMMITTEE/MEETING uploads stay quarantined. Hearings, reports, CH/CM, and certified minutes remain TBD | See [32](32-PHASE-3-MEETINGS.md). Closing a meeting is not certified minutes. `M-{year}-{n}` is not an official series |
| ADR-19 | Selected design | Phase 4 sessions/calendar/roll-call/document-list engineering authorized 2026-09-22. Secretariat-recorded sittings; secretary-entered attendance and tallies; combined calendar; SESSION uploads stay quarantined. Readings, quorum, certified minutes/votes, PO/COU, and IRP remain TBD | See [33](33-PHASE-4-SESSIONS.md). A recorded tally is not a certified result. `S-{year}-{n}` is not an official series |
| ADR-20 | Selected design | Constrained e-Library and reports engineering authorized 2026-09-22. Permission-filtered index of already-visible records; `P-REPORT-INTERIM-1` descriptive counts that reconcile to dashboard KPIs. Official archive, codification, public portal, processing-time analytics, and D-11 official metrics remain TBD | See [34](34-PHASE-7-LIBRARY-REPORTS.md). e-Library is not an official archive. Counts do not score political performance |
| ADR-21 | Selected design | Directory photographs live on the person row (JPEG/PNG, 2 MiB), not the quarantined document pipeline. `person.manage` writes; any signed-in same-municipality principal may read the image so committee faces render. A photograph is not an official portrait, case file, or D-13 scanned document | `PUT/GET /admin/persons/:id/photo`. List APIs return `hasPhoto`/`photoVersion` only. Seed does not invent photographs |
| ADR-22 | Selected design | Constrained demonstration public catalog authorized 2026-09-22 at `/home`, `/track`, `/council`. Anonymous read of municipality, the council directory, and submitted measure titles. Draft and withdrawn case files, subjects, stages, authors, and referral dispositions stay off these routes. Not Phase 9 official publication, approved snapshots, document downloads, or D-08 public-field sign-off | `GET /public/home|measures|council` and `GET /public/persons/:id/photo` for mayor, vice mayor, councilor, SB secretary, and SB staff. No session. No synopsis, audit, users, or quarantined files |
| ADR-23 | Selected design | Public catalog chrome follows the Philippine Government Website Template (GWT 26) used on libungan.gov.ph: GOVPH bar, masthead, PST, transparency/FOI marks, and footer. This is a local demonstration layout, not DICT GWHS hosting, not a replacement of the official municipal website, and not authority to publish | `/ordinances`, `/resolutions`, `/about`, `/contact` added. Official-site About/news/charter pages stay on libungan.gov.ph |
| ADR-24 | Selected design | Constrained historical-ordinance register authorized 2026-09-24. Staff encode a prior-term ordinance directly, without a legislative measure, and may attach a JPEG, PNG, or PDF scan. Keyword search uses title, number, source note, and text read from the scan. Recognized text is stored beside the image and is not a certified copy. Blank year or number stays unknown. This is not `archive.manage`, not an accession, not codification, and not official publication | `archive.view` for SEC, AUD, and LS. `archive.encode` for SEC only. See [35](35-HISTORICAL-ORDINANCES.md) |
